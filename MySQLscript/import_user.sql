...
--         select replace(replace(jsonData->'$.user_id', '"',''), '"','') , jsonData->'$.name', jsonData->'$.review_count',
--         jsonData->'$.fans', replace(replace(jsonData->'$.friends', '"',''), '"','')
-- 	from user_json_temp;

insert into user (user_id, user_name, review_count, fans_count, friends_list_str)
        select replace(jsonData->'$.user_id', '"',''), jsonData->'$.name', jsonData->'$.review_count',
        jsonData->'$.fans', replace(jsonData->'$.friends', '"','')
