...
/**
 * QueryUserNameReviewedFoodInTrainStation
 */
public class QueryUserNameReviewedFoodInTrainStation extends Query {

    //review date input format year-month-day
    String queryStmt = "select user_name from located_in, food, review, user" + 
        " where located_in.location_type = \"train station\" " +
     ...
     */
    public QueryUserNameReviewedFoodInTrainStation() {
        String options[] = { "查询类别-User", "查询分类-Review", "Range-Date"
        , "BusinessType-Food", "LocationType-Train Station" };
