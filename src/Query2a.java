...
public class Query2a extends Query {
    ...
    String queryStmt = "select businessView.name, goodReview.count, badReview.count from businessView," 
     ...
     */
    public Query2a() {
        String options[] = { "SearchCategory-business", "QueryType-BusinessType", "BusinessType-TypeRestaurant", "Specific - have more than half receieved ratings hihger than 3 " };
