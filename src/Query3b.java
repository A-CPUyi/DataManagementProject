...
public class Query3b extends Query {
    ...
    String queryStmt = "select business_name from business, business_location, business_checkin, shopping" 
    		+ " where business.id = shopping.id"
     ...
     */
    public Query3b() {
        String options[] = { "SearchCategory-business", "QueryType-BusinessType", "BusinessType-TypeShopping", "Specific - order by popularity during given time period" };
